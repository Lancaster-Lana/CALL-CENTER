namespace Laneta.EntityFramework
{
    ...
    public static class DBInitializer //: DropCreateDatabaseIfModelChanges<AppDBContext>
    {
        ...
        public static void Initialize(AppDBContext context)
        {
            ...
            var serviceTicket = context.ServiceTickets.Add(new ServiceTicket
            {
                ...
                Description = " two months ago, I started getting randomly disconnected. My modem would lose its ONLINE green light, then the SEND light, then the RECEIVE, and then finally the POWER light would go and the modem would reset itself. I bought the new one wondering if it my old router might be the problem (it was fairly old). However, the problem still persists",
            ...
            context.ScheduleItems.Add(new ScheduleItem
            {
                ...
                ServiceTicket = serviceTicket.Entity,
